<template>
  <div class="text3">
    ...
    <el-form :inline="true">
      <el-form-item>
        <el-input v-model="school" placeholder="学生姓名/学校名称"></el-input>
      </el-form-item>
      <el-form-item>
      ...
      <el-table-column fixed="right" label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small">
            <router-link :to="{name:'a9'}">删除</router-link>
          </el-button>
        </template>
      </el-table-column>
    </el-table>
  ...
  export default {
    ...
    methods: {
      onSubmit1() {
        this.$http({
          method: 'get',
          url: 'http://localhost:9527/traffic/admin/onlyfind?stuname=' + this.school,
        }).then(response => {
      ...
      onSubmit2() {
        this.$http({
          method: 'get',
          url: 'http://localhost:9527/traffic/admin/findstudent?school=' + this.school,
        }).then(response => {
          const data = response.data;
          console.log(data);
          //var list=[];
